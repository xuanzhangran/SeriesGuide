...
//    CGFloat buttonWidth = self.scrollView.frame.size.width/5;
    ...
    for (NSInteger i = 0; i < channelNameArray.count; i++) {
        ...
        button.frame = CGRectMake(i*buttonWidth, 0, buttonWidth, 30);
...
- (void)setUpUI {
    ...
    self.backgroundColor = SGColorOrange;
    ...
    //3.初始化被选中channelButton的红线，也就是indicatorView
...
- (UIScrollView *)createScrollView {
    ...
    scrollView.backgroundColor = SGColorOrange;
    scrollView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 30);
...
- (UIButton *)createChannelButton{
    ...
    button.backgroundColor = SGColorOrange;
    [button setTitleColor:UIColor.whiteColor forState:UIControlStateNormal];
    [button setTitleColor:SGColorRed forState:UIControlStateDisabled];
...
//    CGFloat buttonWidth = self.scrollView.frame.size.width/5;
    ...
    button.frame = CGRectMake(self.scrollView.contentSize.width - buttonWidth , 0, buttonWidth, 30);
